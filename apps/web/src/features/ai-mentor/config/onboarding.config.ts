...
export const ONBOARDING_STAGES: Record<OnboardingStage, OnboardingStageConfig> = {
  entry: {
    ...
    description: 'Початок роботи з ментором',
...
export const ONBOARDING_MESSAGES = {
  ...
  goal: {
    intro: 'Точка Б є. Тепер — цілі. 5 конкретних цілей.',
    instruction:
  ...
  choice: {
    ...
    instruction:
      'Система буде фіксувати "зраду рішенню" щоразу, коли ти обиратимеш старе замість нового.',
    cta: 'Зрозуміло',
  },
  actions: {
    intro: 'Час дій. 2-3 конкретні кроки.',
    instruction:
      'Термін: 7 або 14 днів. Система перевірятиме виконання. Без дій — все залишається на папері.',
    cta: 'Встановити дії',
  },
  completed: {
    message:
      'Онбординг завершено. Тепер у тебе є: бачення, ціль, система рішень, дії. Щодня менторський контур буде тримати тебе в рамках системи. Без поблажок.',
