// frontend/src/features/zoom/components/RequestsList.tsx
// Форма для подачі запиту на сесію — зберігається в ZoomSession.requests Json[]
// Приклад: <RequestsList onClose={() => setShow(false)} />
...
export default function RequestsList({ onClose, sessionId }: RequestsCollectorProps) {
