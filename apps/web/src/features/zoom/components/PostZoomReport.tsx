// frontend/src/features/zoom/components/PostZoomReport.tsx
// Відображає postSessionReport (Json) після завершеної сесії
// Приклад: <PostZoomReport report={session.postSessionReport} />
...
export default function PostZoomReport({ report }: PostZoomReportProps) {
  return (
