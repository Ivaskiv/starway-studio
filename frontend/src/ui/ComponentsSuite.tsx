// frontend/src/ui/components-suite.tsx
...
export const Progress = forwardRef<HTMLDivElement, ProgressProps>(
  ({ value, max = 100, color = 'orange', size = 'md', showLabel = false, className, ...props }, ref) => {
    ...
    return (
      <div ref={ref} {...props}>
        <div className={cn('w-full bg-white/10 rounded-full overflow-hidden', sizes[size], className)}>
          <div 
