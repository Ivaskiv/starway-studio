...
const SIDEBAR_NAV: SidebarNavSection[] = [
  ...
  {
    id: 'my-products', label: 'Мої програми', visibleTo: [],
    items: [
      {
        id: 'ai-mentor', label: 'AI-Ментор', icon: '🤖',
        path: '/dashboard/ai-mentor',
        visibleTo: [],
      },
      {
        id: 'praktykum', label: 'Практикум 5 точок', icon: '💎',
        path: '/dashboard/praktykum',
        visibleTo: [],
        requiresEnrollment: 'praktykum',
      },
      {
  ...
  {
    id: 'expert-tools', label: 'Мій продукт', visibleTo: ['EXPERT', 'SUPERADMIN'],
    items: [
      { id: 'my-product', label: 'Огляд продукту', icon: '📦', path: '/dashboard/products',  visibleTo: ['EXPERT', 'SUPERADMIN'] },
      { id: 'clients',    label: 'Клієнти',        icon: '◈',  path: '/dashboard/clients',   visibleTo: ['EXPERT', 'SUPERADMIN'] },
      { id: 'sessions',   label: 'Сесії',          icon: '◷',  path: '/dashboard/sessions',  visibleTo: ['EXPERT', 'SUPERADMIN'], badge: '3' },
      { id: 'reports',    label: 'Звіти',          icon: '◻',  path: '/dashboard/reports',   visibleTo: ['EXPERT', 'SUPERADMIN'] },
      { id: 'tg-bot',     label: 'Telegram бот',   icon: '✈️', path: '/dashboard/telegram',  visibleTo: ['EXPERT', 'SUPERADMIN'] },
      { id: 'zoom-exp',   label: 'Zoom сесії',     icon: '📹', path: '/dashboard/zoom',      visibleTo: ['EXPERT', 'SUPERADMIN'] },
    ],
  },

  {
    id: 'ai-tools', label: 'AI інструменти', visibleTo: ['EXPERT', 'SUPERADMIN'],
    items: [
      { id: 'ai-funnel',    label: 'AI Воронка',    icon: '🚀', path: ROUTES.AI_FUNNEL_BUILDER,  visibleTo: ['EXPERT', 'SUPERADMIN'], highlight: true },
      { id: 'ai-generator', label: 'AI Генератор',  icon: '✦',  path: ROUTES.AI_GENERATOR,       visibleTo: ['EXPERT', 'SUPERADMIN'], badge: '2/10', highlight: true },
      { id: 'ai-producer',  label: 'AI Producer',   icon: '🎬', path: '/dashboard/ai-producer',  visibleTo: ['EXPERT', 'SUPERADMIN'] },
      { id: 'ai-seo',       label: 'SEO аналіз',    icon: '📊', path: '/dashboard/ai-seo',       visibleTo: ['EXPERT', 'SUPERADMIN'] },
    ],
  },

  {
    id: 'account', label: 'Акаунт', visibleTo: [],
    items: [
  ...
  {
    id: 'superadmin', label: '✦ SuperAdmin', visibleTo: ['SUPERADMIN'], accent: true,
    items: [
      { id: 'adm-users',     label: 'Користувачі',  icon: '👥', path: '/dashboard/admin/users',     visibleTo: ['SUPERADMIN'] },
      { id: 'adm-products',  label: 'Продукти',     icon: '📦', path: '/dashboard/admin/products',  visibleTo: ['SUPERADMIN'] },
      { id: 'adm-mentors',   label: 'Ментори',      icon: '🤖', path: '/dashboard/admin/mentors',   visibleTo: ['SUPERADMIN'] },
      { id: 'adm-questions', label: 'Питання бота', icon: '💬', path: '/dashboard/admin/questions', visibleTo: ['SUPERADMIN'] },
      { id: 'adm-schedule',  label: 'Розклад',      icon: '🕐', path: '/dashboard/admin/schedule',  visibleTo: ['SUPERADMIN'] },
      { id: 'adm-revenue',   label: 'Revenue',      icon: '💰', path: '/dashboard/admin/revenue',   visibleTo: ['SUPERADMIN'] },
      { id: 'adm-funnels',   label: 'Воронки',      icon: '🚀', path: '/dashboard/admin/funnels',   visibleTo: ['SUPERADMIN'] },
      { id: 'adm-stats',     label: 'Статистика',   icon: '📈', path: '/dashboard/admin',           visibleTo: ['SUPERADMIN'] },
      { id: 'adm-transfer',  label: 'Передача прав', icon: '🔑', path: '/dashboard/admin/transfer-ownership', visibleTo: ['SUPERADMIN'] },
    ],
  },
]
