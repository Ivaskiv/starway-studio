// /features/integrations/components/TelegramModal.tsx
...
export function TelegramModal({ isOpen, onClose, onConnect }: TelegramModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-in fade-in duration-300">
      ...
      <GlassCard blur="xl" className="relative w-full max-w-md animate-in zoom-in duration-300">
        <Button
          onClick={onClose}
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="p-4 rounded-xl bg-amber-500/10 border border-amber-500/20">
            <div className="flex gap-3">
              ...
              <p className="text-sm text-amber-200/80">Без Telegram ти не отримаєш нагадування</p>
            </div>
          </div>

          <div className="space-y-3">
            <Button color="orange" size="lg" fullWidth onClick={onConnect}>
              Підключити Telegram
            </Button>
            <Button variant="ghost" color="white" size="md" fullWidth onClick={onClose}>
              Пізніше
            </Button>
          </div>
        </div>
