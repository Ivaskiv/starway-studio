...
export default function ABTesting() {
  ...
  const pauseTest = (id: string) => {
    setTests(tests.map(t => (t.id === id ? { ...t, status: 'paused' as const } : t)));
  };
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2">
                        ...
                        {isWinner && <CheckCircle size={16} className="text-green-400" />}
                      </div>
                      <span className="text-xl font-bold text-orange-400">{conversion_rate}%</span>
                    </div>
