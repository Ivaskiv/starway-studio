// frontend/src/components/FunnelEditor/FunnelEditor.tsx

import { useState } from 'react';
// import { useAppDispatch, useAppSelector } from '../../store/hooks';
import { useAppDispatch, useAppSelector } from '@/frontend/srcapp/store/hooks';
import { FunnelStep, StepType } from '@/frontend/srcfeatures/funnels/types/funnel.types';
    ...
    <div className="flex h-full">
      ...
      <div className="w-80 border-r border-gray-200 bg-gray-50 overflow-y-auto">
        <div className="p-4 border-b border-gray-200 bg-white">
          <h2 className="text-lg font-semibold text-gray-900">{activeFunnel.name}</h2>
          <p className="text-sm text-gray-500 mt-1">{activeFunnel.steps.length} кроків</p>
        </div>
        ...
        {selectedStep ? (
          ...
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              <p className="text-gray-500 mb-4">Виберіть крок для редагування або додайте новий</p>
              <Button onClick={() => handleAddStep('message')} variant="primary" size="lg">
