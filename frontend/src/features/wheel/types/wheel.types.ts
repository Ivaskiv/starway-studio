...
export const WHEEL_CATEGORIES: WheelCategory[] = [
  ...
  { id: 'relationships', name: 'Relationships', nameUk: 'Стосунки', emoji: '❤️', color: '#EF4444', description: 'Сім’я, друзі, робота' },
  { id: 'personal_growth', name: 'Personal Growth', nameUk: 'Особистий ріст', emoji: '🌱', color: '#8B5CF6', description: 'Навички, розвиток' },
  { id: 'fun', name: 'Fun & Recreation', nameUk: 'Відпочинок', emoji: '🎉', color: '#EC4899', description: 'Хобі, радість, розваги' },
  { id: 'environment', name: 'Environment', nameUk: 'Оточення', emoji: '🏠', color: '#06B6D4', description: 'Середовище, цінності' },
  { id: 'spirituality', name: 'Spirituality', nameUk: 'Духовність', emoji: '✨', color: '#A855F7', description: 'Внутрішня гармонія, медитація' },
]
