        ...
        {options.map(opt => (
          <button
            ...
            className={cn(
              ...
              value === opt.value ? 'bg-orange-500 text-white' : 'text-white/60 hover:text-white hover:bg-white/5',
    ...
    <div className="max-w-2xl mx-auto p-4 md:p-6 space-y-6">
      <GlassCard blur="lg">
        ...
        <GlassCardContent>
          <SettingsToggle
            label="Тема"
            icon={formData.theme === 'dark' ? <Moon className="w-4 h-4" /> : <Sun className="w-4 h-4" />}
