...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // fix code_x: align Tailwind tokens with RGB CSS vars to keep alpha utilities correct.
      ...
      keyframes: {
        ...
        glowPulse: {
          '0%, 100%': { boxShadow: '0 0 30px rgba(var(--accent-rgb),0.65)' },
          '50%': { boxShadow: '0 0 50px rgba(var(--accent-rgb),0.9)' },
        },
