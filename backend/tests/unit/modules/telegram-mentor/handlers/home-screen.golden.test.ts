...
import { buildHomeScreen } from '../homeScreen.builder.ts'
import type { StartUserSnapshot } from '../start.ts'
import type { StartContext } from '../start.shared.ts'
...
import { resolveTelegramProductSummary } from '../../services/product/summary.ts'
