...
vi.mock('../../telegram-mentor/services/context/request.ts', () => ({
...
vi.mock('../../telegram-mentor/services/context/intelligence.ts', () => ({
  ...
  appendTelegramConversationTurn: vi.fn(async (
    ...
    Object.assign(context as unknown as { recentConversation: typeof context.recentConversation; lastInteraction: typeof context.lastInteraction; lastAssistantMessage: typeof context.lastAssistantMessage }, {
      recentConversation: updatedConversation,
      lastInteraction: updatedConversation.at(-1) ?? null,
...
vi.mock('../../ai/gateway/index.ts', async () => {
  const actual = await vi.importActual<typeof import('../../ai/gateway/index.ts')>('../../ai/gateway/index.ts')
...
import { assistantChat } from '@/modules/assistant/service.js'
import { chat as restChatController } from '../controller.ts'
import { sendMessage as websiteChatController, streamChat as sseChatController } from '../../ai-mentor/controllers.ts'
import { handleIntelligentMessage } from '../../telegram-mentor/handlers/intelligence.handler.ts'
