// backend/src/products/ab-system/telegram/service.ts
...
import { splitTelegramContentBlocks, sendTelegramContentChunk } from './views.js'
...
export { resolveAiSellerMode } from './ai-seller.js'
...
export { handleAbTestEmailCaptureText, resolveFocusShortcutCallback } from './flow.js'
