//backend/src/products/ab-system/telegram/callback.ts
...
export { formatMobileAnswerButtonText, formatMobileAnswerListForMessage } from './helpers.js'
...
export async function sendStructuredTelegramMessage(
  ...
  const { packTelegramContentBlocks, splitTelegramContentBlocks, sendTelegramContentChunk } = await import('./views.js')
