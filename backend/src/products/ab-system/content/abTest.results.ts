...
const AB_TEST_RESULTS_BASE = defineAbTestResultBase({
  state: {
    ...
    msg1_story:
      'Я дуже добре знаю цей стан. Скільки б ти не обіцяла собі почати з понеділка чи взяти себе в руки — нічого не виходить. Бо коли сил майже немає, ці сили просто нема з чого взяти.',
  ...
  goal: {
    ...
    msg1_audio:
      'Мене звати Надя.\nЯ працюю з жінками, які проходять через схожі ситуації. Хочу коротко розповісти, що я побачила і чому багато хто знову і знову стикається з одними й тими самими ситуаціями.\nПослухай голосове.',
    msg2_audio:
  ...
  decision: {
    ...
    msg1_audio:
      'Мене звати Надя.\nЯ побачила: найважче — це перший крок після того, як рішення вже прийняте.\nПослухай голосове.',
    msg2_audio:
  ...
  action: {
    ...
    msg1_story:
      'Я теж довго намагалася вирішити все одразу. Робила більше, брала нові задачі, шукала інші підходи.\nА потім побачила: увага розсіювалась по всіх задачах одразу — і жодна не отримувала стільки, щоб зрушити з місця.',

    title: 'ДІЯ',

    msg1_audio:
      'Мене звати Надя.\nЯ працюю з жінками, які хочуть змін, але втомилися постійно бігти й не бачити результату.\nУ голосовому розповім, що я помітила.',
    msg2_audio:
...
function extractReviewHeader(text: string): string {
  // Review text is wrapped as `**${header}**`, so for multiline headers
  // we need to remove only the synthetic outer markers and keep inner emphasis.
  ...
  headerLines[0] = headerLines[0].replace(/^\*\*/, '')
