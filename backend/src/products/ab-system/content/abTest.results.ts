...
export const AB_TEST_RESULTS: Record<AbTestResultKey, AbTestResultDefinition> =
  {
    ...
    state: {
      ...
      msg2: [
        ...
        AB_TEST_NEONILA_REVIEW_HEADER,
        '',
        buildAbTestScreenshotMarker('state_review'),
        '',
    ...
    goal: {
      ...
      msg2: [
        ...
        AB_TEST_NEONILA_REVIEW_HEADER,
        '',
        buildAbTestScreenshotMarker('goal_review'),
        '',
        'Почати можна з одного місяця участі.',
        ...AB_TEST_VOICE_NOTE_LINES,
        '',
    ...
    choice: {
      ...
      msg2: [
        ...
        AB_TEST_VALENTYNA_REVIEW_HEADER,
        '',
        buildAbTestScreenshotMarker('choice_review'),
        '',
        'Почати можна з одного місяця участі.',
        ...AB_TEST_VOICE_NOTE_LINES,
        '',
    ...
    decision: {
      ...
      msg2: [
        ...
        AB_TEST_YELYZAVETA_REVIEW_HEADER,
        '',
        buildAbTestScreenshotMarker('decision_review'),
        '',
        'Почати можна з одного місяця участі.',
        ...AB_TEST_VOICE_NOTE_LINES,
        '',
    ...
    action: {
      ...
      body: [
        ...
        AB_TEST_KSENIIA_REVIEW_HEADER,
        '',
        buildAbTestScreenshotMarker('action_review_1'),
        '',
        ...AB_TEST_VOICE_NOTE_LINES,
        '',
      ...
      msg2: [
        ...
        AB_TEST_KSENIIA_REVIEW_HEADER,
        '',
        buildAbTestScreenshotMarker('action_review_2'),
        '',
        'Почати можна з одного місяця участі.',
        ...AB_TEST_VOICE_NOTE_LINES,
        '',
