...
export const FOCUS_PAYMENT_ISSUE_USER_MSG =
  'Ми не бачимо підтвердження оплати в системі.\n\n' +
  'Будь ласка, перевір ще раз:\n' +
  '1. чи платіж точно завершився;\n' +
  '2. чи є списання в банку;\n' +
  '3. чи прийшов чек або підтвердження від WayForPay.\n\n' +
  'Якщо оплата справді пройшла, надішли у відповідь на це повідомлення чек, скрін підтвердження або дані платежу: дату, час, суму й останні 4 цифри картки.'
