...
vi.mock('../../modules/access/service.js', () => ({
...
vi.mock('../../lib/cache/index.js', () => ({ cacheDel: vi.fn() }))
vi.mock('../../lib/db/dailyCache.js', () => ({ invalidateDailyHistoryCache: vi.fn(), invalidateDayCache: vi.fn() }))
vi.mock('../../lib/telegram.js', () => ({ sendDedupedTelegramMessage: vi.fn() }))
vi.mock('../../lib/notifications/templates.js', () => ({ buildNotificationContent: vi.fn() }))
vi.mock('../../modules/telegram-mentor/services/nudge.service.js', () => ({ processScheduledNudges: vi.fn() }))
...
vi.mock('../../modules/web-map/web-map.service.js', () => ({ runMonthlyAnalysis: vi.fn() }))
vi.mock('../../modules/users/runtime/resolveUserLifecycle.js', () => ({ resolveDisplayName: vi.fn(() => 'Vira') }))
vi.mock('../notifications/mentorLifecycle.js', () => ({ resolvePausedMentorContext: vi.fn() }))
vi.mock('../notifications/services/NotificationRecordService.js', () => ({ notificationRecordService: { create: vi.fn() } }))

import { subscriptionExpiredCron, subscriptionExpiringCron } from './operations.jobs.js'
