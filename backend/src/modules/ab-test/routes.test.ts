...
vi.mock('../../products/ab-system/content/abTest.questions.js', () => ({
...
vi.mock('../../products/ab-system/telegram/abTest.handlers.core.js', () => ({
  persistCanonicalCompletedAbTestProgress: (...args: unknown[]) =>
    persistCanonicalCompletedAbTestProgressMock(...args),
}))

vi.mock('../../core/state-machine/testFoundation.js', () => ({
...
vi.mock('../../core/behavioral/buildBehavioralNarrative.js', () => ({
  buildBehavioralNarrative: vi.fn(() => 'narrative'),
}))

vi.mock('../../core/behavioral/behavioralSnapshot.js', () => ({
  buildBehavioralSnapshot: vi.fn(() => ({ snapshot: true })),
}))

vi.mock('../users/runtime/resolveUserLifecycle.js', () => ({
  resolveUserLifecycle: vi.fn(() => ({ value: 'TEST_DONE' })),
}))

vi.mock('../auth/getServerUser.js', () => ({
