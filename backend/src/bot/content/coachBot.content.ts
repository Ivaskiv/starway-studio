...
export const coachBotContent = {
  start: {
    title: 'Coach OS',
    subtitle: 'Єдиний потік коуча: новий Zoom, бібліотека, аналітика, контент, агенти і системні дії.',
  },
  access: {
  ...
  system: {
    ...
    agentsSubtitle: 'Керування агентами Starway Studio.',
