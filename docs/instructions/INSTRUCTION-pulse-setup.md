...
SKILL-content.md → контент-машина
SKILL-funnel.md  → воронка продажів
SKILL-ux-copy.md → копі для бота
SKILL-client-dna.md    → ДНК клієнта
SKILL-creative-ads.md  → відео і рілси
SKILL-ai-positions.md  → позиції Пульта
SKILL-must-ban.md      → теги MUST/BAN
SKILL-output-engine.md → формати виходу
...
const SKILL_CONTENT = readFileSync('skills/SKILL-content.md', 'utf-8');
...
│   ├── SKILL.md               ← оффери
│   ├── SKILL-content.md       ← контент
│   ├── SKILL-funnel.md        ← воронка
│   ├── SKILL-ux-copy.md       ← копі бота
│   ├── SKILL-client-dna.md    ← ДНК клієнта
│   ├── SKILL-creative-ads.md  ← відео/рілси
│   ├── SKILL-ai-positions.md  ← позиції пульта
│   ├── SKILL-must-ban.md      ← теги
│   ├── SKILL-output-engine.md ← формати виходу
