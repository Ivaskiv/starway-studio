...
- Platform control center: `docs/platform/README.md`
- Lifecycle propagation: `docs/automation/lifecycle-map.md`
- Telegram runtime architecture: `docs/automation/telegram-architecture.md`
...
- Lifecycle state semantics stay canonical in `docs/automation/lifecycle-map.md`.
- Platform operational policy stays canonical in `docs/platform/README.md`.
- Telegram routing/runtime hierarchy stays canonical in `docs/automation/telegram-architecture.md`.
