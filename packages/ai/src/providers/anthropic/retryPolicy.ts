import type { AnthropicRetryPolicyConfig, IAnthropicRateLimitHandler, IAnthropicRetryPolicy } from './types.js'
...
export class RetryPolicy implements IAnthropicRetryPolicy {
  ...
  constructor(
    private readonly rateLimitHandler: IAnthropicRateLimitHandler,
    private readonly sleep: (ms: number) => Promise<void> = (ms) => new Promise((resolve) => setTimeout(resolve, ms)),
    config: AnthropicRetryPolicyConfig = {},
  ) {
...
function isRetryable(error: unknown, rateLimitHandler: IAnthropicRateLimitHandler): boolean {
