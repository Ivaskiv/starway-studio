import type { IRateLimitHandler, OpenAIRateLimitConfig } from './types.js'

const DEFAULT_DELAY_MS = 1_000
const DEFAULT_MAX_DELAY_MS = 30_000

export class RateLimitHandler implements IRateLimitHandler {
  private readonly defaultDelayMs: number
  private readonly maxDelayMs: number

  constructor(config: OpenAIRateLimitConfig = {}) {
