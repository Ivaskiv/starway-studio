import type { IRateLimitHandler, IRetryPolicy, OpenAIRetryPolicyConfig } from './types.js'
...
export class RetryPolicy implements IRetryPolicy {
  ...
  constructor(
    private readonly rateLimitHandler: IRateLimitHandler,
    private readonly sleep: (ms: number) => Promise<void> = (ms) => new Promise((resolve) => setTimeout(resolve, ms)),
    config: OpenAIRetryPolicyConfig = {},
  ) {
...
function isRetryable(error: unknown, rateLimitHandler: IRateLimitHandler): boolean {
