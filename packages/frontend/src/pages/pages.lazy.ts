...
// Dashboard
export const DashboardPage = lazy(() => import('../features/home/DashboardPage'))
...
// Users
export const UsersPage = lazy(() => import('../features/auth/users/UsersPage'))

// Settings
export const SettingsPage = lazy(() => import('./SettingsPage'))

// ============ USER PAGES ============
export const CoursesPage = lazy(() => import('../features/products/pages/CoursesPage'))
