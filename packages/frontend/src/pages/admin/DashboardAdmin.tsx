// packages/frontend/src/pages/admin/DashboardAdmin.tsx
...
export default function DashboardAdmin() {
  ...
  useEffect(() => {
    // TODO: Завантажити статистику з API
    setStats({
      totalFunnels: 12,
      activeFunnels: 8,
      totalUsers: 342,
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-1">Керуйте своїми воронками</p>
        </div>
        <Link
          to="/admin/funnels/create"
      ...
      <div className="bg-gray-900 rounded-lg p-6">
        <h2 className="text-xl font-bold text-white mb-4">Останні воронки</h2>
        <div className="text-gray-400">
          Тут буде список воронок...
        </div>
      </div>
    </div>
  );
