// packages/frontend/src/components/funnel/stepConfigs/TelegramStepConfig.tsx

import { useState } from 'react';
import { MessageCircle, Plus, Trash2, Sparkles } from 'lucide-react';
import { Button, Input, Textarea, Select } from '@starway/shared/ui';
import { buildPrompt } from '@frontend/lib/aiPrompts';
