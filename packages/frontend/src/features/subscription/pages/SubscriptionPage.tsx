    ...
    <div className="space-y-8 max-w-5xl mx-auto">
      ...
      {!hasSubscription && trialDaysLeft > 0 && (
        <motion.div
          ...
          className="p-4 rounded-2xl bg-gradient-to-r from-amber-500/20 to-orange-500/20 border border-amber-500/30 text-center"
        >
      ...
      <GlassCard className="p-6">
        ...
        <div className="space-y-4">
          {[
            { q: 'Чи можу я скасувати підписку?', a: 'Так, ви можете скасувати підписку в будь-який момент. Доступ залишиться до кінця оплаченого періоду.' },
            { q: 'Які методи оплати доступні?', a: 'Приймаємо карти Visa, Mastercard через WayForPay, а також Apple Pay та Google Pay.' },
            { q: 'Чи є гарантія повернення коштів?', a: 'Так, протягом 7 днів після оплати ви можете повернути кошти без пояснень.' },
          ].map((faq, i) => (
