...
export default function StepCard({
  ...
  const hasOptions = 'options' in stepDef;

  return (
    <GlassCard className="p-6 md:p-8" data-hover="lift">
      {/* Header */}
      <div className="flex items-start gap-4 mb-6">
        <div className="w-12 h-12 md:w-16 md:h-16 rounded-xl bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center shadow-lg flex-shrink-0">
        ...
        {hasOptions ? (
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {stepDef.options.map((option: string) => (
                <button
                  key={option}
